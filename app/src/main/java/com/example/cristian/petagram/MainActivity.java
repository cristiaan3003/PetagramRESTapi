package com.example.cristian.petagram;
...
import com.example.cristian.petagram.adapter.PageAdapter;
import com.example.cristian.petagram.fragment.PerfilFragment;
import com.example.cristian.petagram.fragment.RecyclerViewFragment;
import com.example.cristian.petagram.notificaciones.EndPointsNotificaciones;
import com.example.cristian.petagram.notificaciones.adapter.RestApiAdapterNotificaciones;
import com.example.cristian.petagram.notificaciones.model.UsuarioResponse;
    ...
    public void lanzarDeviceID(){
        ...
        usuarioResponseCall.enqueue(new Callback<UsuarioResponse>() {
            ...
            public void onResponse(Call<UsuarioResponse> call, Response<UsuarioResponse> response) {
                ...
                Log.d("NELSON==", usuarioResponse.getId());
                Log.d("NELSON==", usuarioResponse.getId_dispositivo());
                Log.d("NELSON==", usuarioResponse.getId_usuario_instagram());
            }
            @Override
